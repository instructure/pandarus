...
module Pandarus
  class Quiz < ModelBase
    attr_accessor :id, :title, :html_url, :mobile_url, :preview_url, :description, :quiz_type, :assignment_group_id, :time_limit, :shuffle_answers, :hide_results, :show_correct_answers, :show_correct_answers_at, :hide_correct_answers_at, :one_time_results, :scoring_policy, :allowed_attempts, :one_question_at_a_time, :question_count, :points_possible, :cant_go_back, :access_code, :ip_filter, :due_at, :lock_at, :unlock_at, :published, :unpublishable, :locked_for_user, :lock_info, :lock_explanation, :speedgrader_url, :quiz_extensions_url, :permissions, :all_dates
    ...
    def self.attribute_map
      {
        ...
        :one_time_results => {:external => "one_time_results", :container => false, :type => nil},
        ...
        :quiz_extensions_url => {:external => "quiz_extensions_url", :container => false, :type => "String"},
