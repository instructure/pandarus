    ...
    def self.attribute_map
      {
        ...
        :mobile_url => {:external => "mobile_url", :container => false, :type => nil},
        :description => {:external => "description", :container => false, :type => nil},
        :quiz_type => {:external => "quiz_type", :container => false, :type => nil},
        :assignment_group_id => {:external => "assignment_group_id", :container => false, :type => nil},
        :time_limit => {:external => "time_limit", :container => false, :type => nil},
        ...
        :question_count => {:external => "question_count", :container => false, :type => nil},
        ...
        :access_code => {:external => "access_code", :container => false, :type => nil},
        :ip_filter => {:external => "ip_filter", :container => false, :type => nil},
