...
module Pandarus
  class GroupCategory < ModelBase
    attr_accessor :id, :name, :role, :self_signup, :auto_leader, :context_type, :account_id, :group_limit, :progress
    ...
    def self.attribute_map
      {
        ...
        :auto_leader => {:external => "auto_leader", :container => false, :type => "String"},
