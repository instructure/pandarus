    ...
    def self.attribute_map
      {
        ...
        :needs_grading_count_by_section => {:external => "needs_grading_count_by_section", :container => true, :type => "NeedsGradingCount"},
        :position => {:external => "position", :container => false, :type => "Integer"},
        :post_to_sis => {:external => "post_to_sis", :container => false, :type => nil},
        :integration_id => {:external => "integration_id", :container => false, :type => "String"},
        :integration_data => {:external => "integration_data", :container => false, :type => "String"},
